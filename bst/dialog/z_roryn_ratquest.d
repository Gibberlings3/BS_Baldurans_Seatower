...
== %GARRICK_JOINED% IF ~InParty("garick") InMyArea("garick") !StateCheck("garick",CD_STATE_NOTVALID)~ THEN ~Are you sure you have enough grain on you? These little guys like to eat.~
== %JAHEIRA_JOINED% IF ~InParty("JAHEIRA") InMyArea("JAHEIRA") !StateCheck("JAHEIRA",CD_STATE_NOTVALID) InParty("garick") InMyArea("garick") !StateCheck("garick",CD_STATE_NOTVALID)~ THEN ~Garick, this animal doesn't really look starved. I am sure it will do fine without anything to eat for a while. At least for as long as it takes <CHARNAME> to return it to its... "owner".~
